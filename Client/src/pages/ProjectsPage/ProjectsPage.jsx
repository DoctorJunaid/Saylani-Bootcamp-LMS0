              ...
              <table className="w-full min-w-[720px] border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left text-xs font-weight-semibold text-text-muted uppercase tracking-wide px-lg py-md">
                      Project
                    </th>
                    <th className="text-left text-xs font-weight-semibold text-text-muted uppercase tracking-wide px-lg py-md">
                      Team
                ...
                <tbody>
                  {filteredProjects.map((project) => (
                    <ProjectCard
                      ...
                      // Abhi separate Edit/Delete flow nahi hai, isliye
                      // teeno actions ProjectDetailsModal kholte hain
                      // (jahan onUpdate={loadProjects} se update/delete
                      // ho sakta hai). Jab alag Edit/Delete handlers
                      // banayein, bas yahan onEdit/onDelete replace kar dena.
                      onView={handleViewProject}
                      onEdit={handleViewProject}
                      onDelete={handleViewProject}
                    />
                  ))}
                </tbody>
              </table>
