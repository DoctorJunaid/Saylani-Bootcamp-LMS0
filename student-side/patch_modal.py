...
with open('src/pages/tasks/Tasks.jsx', 'r') as f:
    content = f.read()
...
start_idx = content.find('{/* Assignment Details Modal */}')
if start_idx == -1:
...
new_content = """{/* Assignment Details Modal */}
      <Modal
        isOpen={!!selectedTask}
...
with open('src/pages/tasks/Tasks.jsx', 'w') as f:
    f.write(final_content)

print("Tasks.jsx updated.")
